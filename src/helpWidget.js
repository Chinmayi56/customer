...
const RULES = [
  ...
  {
    keywords: ['pay', 'payment', 'cod', 'cash', 'online payment', 'upi', 'card'],
    reply: `We support three payment options during "Get a Code": Cash on Delivery, Online Payment (demo), and Visit the Company to pay in person. You'll pick one in the last step of the purchase flow.`,
  },
  {
